...
<html lang="en">
	...
	<body>
		...
		<center><h2 style=""><a href="registration.php" style="cursor:pointer; color:#fff;">Click Here</a> to register and become a donar</h2></center>
		<hr>
		<center><h2 style="color:green">All Donors List</h2></center>
		<hr>
